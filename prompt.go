...
func selectPrompt(n int) string {
	...
	return strings.Join([]string{
		...
		"",
		"A skill is a written procedure an agent loads before doing work. The catalogue arrives on stdin: one skill per line, a name, a tab, then the description its author wrote — what it does and when to use it. The task follows.",
		"",
